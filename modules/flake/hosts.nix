...
# as the single source of truth
{
  flake.hosts = {
    ...
    x570.interfaces = {
      ...
      wlan1.ipv4 = "172.16.248.10/16";
      eno1.ipv4 = "192.168.59.7/27";
