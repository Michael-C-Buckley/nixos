  ...
  pkgs.writeText "niri-wrapped-config.kdl" ''
    ...
    spawn-sh-at-startup "${noctaliaPath}"
      ...
      binds {
        ...
        Mod+1 { focus-workspace "N1"; }
        Mod+2 { focus-workspace "N2"; }
        Mod+3 { focus-workspace "N3"; }
        Mod+4 { focus-workspace "N4"; }
        Mod+5 { focus-workspace "N5"; }
        Mod+6 { focus-workspace "N6"; }
        Mod+7 { focus-workspace "N7"; }
        Mod+8 { focus-workspace "N8"; }
        Mod+9 { focus-workspace "N9"; }
        Mod+0 { focus-workspace "N0"; }
        Mod+Ctrl+1 { move-column-to-workspace "N1"; }
        Mod+Ctrl+2 { move-column-to-workspace "N2"; }
        Mod+Ctrl+3 { move-column-to-workspace "N3"; }
        Mod+Ctrl+4 { move-column-to-workspace "N4"; }
        Mod+Ctrl+5 { move-column-to-workspace "N5"; }
        Mod+Ctrl+6 { move-column-to-workspace "N6"; }
        Mod+Ctrl+7 { move-column-to-workspace "N7"; }
        Mod+Ctrl+8 { move-column-to-workspace "N8"; }
        Mod+Ctrl+9 { move-column-to-workspace "N9"; }
        Mod+Ctrl+0 { move-column-to-workspace "N0"; }
